...
QT_MOC_LITERAL(2, 15, 9), // "teacherId"
QT_MOC_LITERAL(3, 25, 9), // "subjectId"
QT_MOC_LITERAL(4, 35, 7) // "groupId"

    },
    "BlockObject\0id\0teacherId\0subjectId\0"
    "groupId"
};
...
void BlockObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<BlockObject *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->getid(); break;
        case 1: *reinterpret_cast< int*>(_v) = _t->getteacherId(); break;
        case 2: *reinterpret_cast< int*>(_v) = _t->getsubjectId(); break;
        case 3: *reinterpret_cast< int*>(_v) = _t->getgroupId(); break;
        default: break;
        }
        ...
        case 1: _t->setteacherId(*reinterpret_cast< int*>(_v)); break;
        case 2: _t->setsubjectId(*reinterpret_cast< int*>(_v)); break;
        case 3: _t->setgroupId(*reinterpret_cast< int*>(_v)); break;
        default: break;
        }
...
QT_INIT_METAOBJECT const QMetaObject BlockObject::staticMetaObject = { {
    ...
    qt_meta_stringdata_BlockObject.data,
    qt_meta_data_BlockObject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
