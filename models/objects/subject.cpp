...
bool Subject::subjectType() const
{
    return d->subjectType;
}

void Subject::setSubjectType(bool subjectType)
{
...
Subject Subject::create(const QString &subjectName, bool subjectType)
{
    SubjectObject obj;
...
QJsonArray Subject::getAllJson(const QStringList &properties)
{
